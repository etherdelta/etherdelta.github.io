var translations = {
  ...
  produced_etherboost:{
    ...
    cn:'Etherboost制作',
    en:'Produit par Etherboost'
  },
  etherdelta_desc:{
    en:'EtherDelta &#8212; decentralized token exchange',
    cn:'EtherDelta &#8212; 去中心化交易',
    en:"EtherDelta &#8212; échange de jetons décentralisé"
    // cn:'EtherDelta &#8212; 无中心交易'
  },
  etheropt_desc:{
  ...
  export_private_key:{
    ...
    cn:'导出私钥',
    en:'Exporter la clé privée'
  },
  forget_account:{
    en:'Forget account',
    cn:'忘记账号',
    en:'Oublier le compte'
  },
  forget_all_accounts:{
  ...
  trade_7:{
    ...
    en:'Le GUI detecte les nouveaux ordres arrivant et les affiche dans le carnet d\'ordre (Vente a gauche, Achat a droite).'
  },
  trade_8:{
